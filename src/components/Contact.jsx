...
function Contact(){
    return(
        <div className="flex flex-col items-center justify-center min-h-screen py-12 bg-cover bg-center"
            style={{backgroundImage: "url('https://images.pexels.com/photos/6214393/pexels-photo-6214393.jpeg?_gl=1*p943fk*_ga*MTM5NDYzMTgwNS4xNzc1Nzk5NDg5*_ga_8JE65Q40S6*czE3NzU3OTk0ODgkbzEkZzEkdDE3NzU3OTk1ODYkajI2JGwwJGgw')"}}>
                ...
                <div className="mt-8 text-center">
                    ...
                    <div className="flex flex-col items-center space-y-2 mt-4">
                        <div className="flex items-center ">
                            ...
                            <span className="text-gray-600">+91 9934340276 </span>
                        </div>
                        <div className="flex items-center ">
                            <FaEnvelope  className="text-blue-500 mr-2 "/>
                            <span className="text-gray-600">vastu_online_shop@email.com</span>
                        </div>
                        <div className="flex items-center ">
