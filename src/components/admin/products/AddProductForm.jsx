...
const AddProductForm = ({ setOpen, product, update=false}) => {
  ...
  return (
    <div className='py-5 relative h-full px-5'>
        <form className='space-y-4'
            ...
            <div className='flex md:flex-row flex-col gap-4 w-full'>
                <InputField 
                    ...
                    min={0}
                    onKeyDown={(e) => {
                        // Block the minus sign, plus sign, and the letter 'e' (scientific notation)
        ...
        <div className='flex w-full justify-between items-center absolute bottom-10 left-0 px-5'>
            ...
            <Button
                ...
                variant='contained'
                color='primary'
                className='bg-custom-blue text-white py-10px text-sm font-medium'>
                {loader ? (
