        ...
        <div className='py-14 min-h-[calc(100vh-100px)]'>
            ...
            <div className='lg:w-[80%] mx-auto py-5'>
                ...
                <div className='mt-5'>
                    ...
                    {activeStep === 2 && <OrderSummary totalPrice={totalPrice} cart={cart} address={address} paymentMethod={paymentMethod}/>}
                    {activeStep === 3 &&
                    <>
            ...
            <div className='flex justify-between items-center px-4 fixed z-50 bottom-0 bg-white left-0 w-full py-4 border-slate-950'
                    ...
                    <button disabled = {errorMessage || (
                        ...
                        className={`bg-custom-blue font-semibold px-6 h-10 rounded-md text-white
                            ${
                                errorMessage || 
                                (activeStep === 0 && !selectedUserCheckoutAddress) ||
                                (activeStep === 1 && !paymentMethod) ? "opacity-60" : ""
                            }`}
                            onClick={handleNext} >
                            Proceed
                    </button>
